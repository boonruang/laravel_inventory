    ...
    <div class="card">
        ...
        <div class="row mb-3">
            ...
            <select name="blog_category_id" class="form-select" aria-label="Default select example">
                {{-- SOl1 --}}
                {{-- <option selected="">{{$blogs['category']['blog_category']}}</option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input name="blog_title" class="form-control" value="{{$blogs->blog_title}}" >
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <img id="showImage" class="rounded" style="width:200px" src="{{asset($blogs->blog_image)}}" alt="Card image cap">
            </div>
        </div>   
